...
import inventoryCategoryRoutes from "./routes/inventory-category.routes.js";
import inventorySubcategoryRoutes from "./routes/inventory-subcategory.routes.js";
import inventoryBrandRoutes from "./routes/inventory-brand.routes.js";
import inventoryModelRoutes from "./routes/inventory-model.routes.js";
...
app.use("/api/inventory-subcategories", inventorySubcategoryRoutes);
app.use("/api/inventory-brands", inventoryBrandRoutes);
app.use("/api/inventory-models", inventoryModelRoutes);
